...
<section class="scrollable padder">
 			...
 			<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="{{url('/admin/parameter/create')}}">Add Recommendations</a></li>
                      ...
                      {{Form::open(['route' => 'recommendation.store','files' => true, 'class'=>'form-horizontal course-form','data-parsley-validate'])}}
                      <div class="panel-body">                   
                         <div class="form-group">
                          <label class="col-sm-3 control-label">Recommendation</label>
                          <div class="col-sm-9">
                            <input type="text" name="name" class="form-control"  data-required="true" placeholder="Add Recommendation" required>   
                          </div>
                        </div>
