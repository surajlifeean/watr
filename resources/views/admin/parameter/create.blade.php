...
<section class="scrollable padder">
 			...
 			<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="{{url('/admin/parameter/create')}}">Add Parameters</a></li>
                      ...
                      {{Form::open(['route' => 'parameter.store','files' => true, 'class'=>'form-horizontal course-form','data-parsley-validate'])}}
                      <div class="panel-body">                   
                         <div class="form-group">
                          <label class="col-sm-3 control-label">Parameter Name</label>
                          <div class="col-sm-9">
                            <input type="text" name="name" class="form-control"  data-required="true" placeholder="Name of Parameter" required>   
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="cost" class="form-control"  data-required="true" placeholder="Cost" required>   
                          </div>
                        </div>
                        <div class="line line-dashed line-lg pull-in"></div>
                        <div class="form-group">
