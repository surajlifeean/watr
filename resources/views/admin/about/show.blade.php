                ...
                <li><a href="">Show Course</a></li>
                      ...
                      <div class="panel-body">                   
                         <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="name" class="form-control" value="{{$course[0]->name}}" data-required="true" placeholder="Course Name" disabled>   
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <textarea class="summernote" name="eligibility" class="form-control" required disabled>{{$course[0]->eligibility}}</textarea> 
<!--                             <input type="text" name="yoe" class="form-control"  data-required="true" placeholder="Years Of Experience" data-parsley-type="digits" maxlength="2" required>    -->
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="duration" class="form-control" value="{{$course[0]->duration}}" data-required="true" placeholder="Duration" disabled> 
                          ...
                          <div class="col-sm-9">
                            ...
                            <!-- Text input-->
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-md-5">
                                                  <input id="action_id" name="session_name[]" type="text" value="{{$c->session_name}}" placeholder="" class="form-control input-md" required disabled>
                                                  </div>
                                                  <label class="col-md-4 control-label" for="action_id">Topic</label>  
                                                  <div class="col-md-5">
                                                  <input id="action_id" name="topic[]" type="text" value="{{$c->topic}}" placeholder="" class="form-control input-md" required disabled>
                                                  </div>
                                                </div>
                                                <!-- Text input-->
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-md-5">
                                                  <textarea class="" cols="100" name="description[]" class="form-control" required disabled>{{$c->description}}</textarea> 
